...
plot.windrose <- function(data,
  ...
  dir.labels <- c(0,30,60,90,120,150,180,210,240,270,300,330,0)
 #  dir.labels <- c(paste(360-dirres/2,"-",dirres/2), #345-15
#                   paste(seq(dirres/2, 360-3*dirres/2, by = dirres), #15-45... 315-345
#                         "-",
#                         seq(3*dirres/2, 360-dirres/2, by = dirres)),
#                   paste(360-dirres/2,"-",dirres/2)) #345-15
...
#first you need to cut the data and make a month column
